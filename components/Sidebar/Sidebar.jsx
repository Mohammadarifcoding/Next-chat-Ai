...
const Sidebar = async() => {
  ...
  <nav className="flex-1 p-4 space-y-2  overflow-y-auto">
    <div className="space-y-1">
      <Link href={'/'} className="flex items-center space-x-3 px-3 py-2 rounded-lg hover:bg-gray-800 transition-colors cursor-pointer">
    ...
    <div className="pt-4 ">
      ...
      <div className="space-y-1  mt-3">
        ...
        <Link href={`/chat/${conversation._id}`} key={conversation._id} className="flex items-center space-x-3 px-2 py-2 rounded-lg hover:bg-gray-800 transition-colors cursor-pointer ">
